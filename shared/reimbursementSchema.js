    ...
    sections: [
      {
        ...
        fields: [
          { field: "mainAuthor", label: "Autor kryesor" },
          { field: "correspondingAuthor", label: "Autor korrespondent" },
          { field: "coauthors", label: "Bashkautoret", wide: true, placeholder: "Ndaji me presje ose rreshta" },
        ],
      },
      {
        ...
        fields: [
          { field: "affiliation", label: "Perkatesia e autorit (affiliation)", wide: true },
          { field: "publicationTitle", label: "Titulli i punimit", wide: true, required: true },
          { field: "journal", label: "Emri i revistes" },
          { field: "publisher", label: "Shtepia botuese" },
          { field: "indexingPlatform", label: "Indeksim ne platforme", placeholder: "Scopus, Web of Science, DOAJ..." },
          { field: "impactFactor", label: "Impact faktori (IF)" },
          { field: "scopusQuartile", label: "Scopus (Q1-Q4)", type: "select", optionsKey: "scopus" },
          { field: "acceptanceDate", label: "Data e pranimit", type: "date" },
          { field: "publicationDate", label: "Data e publikimit", type: "date" },
          { field: "publicationLink", label: "Linku i publikimit", wide: true, placeholder: "https://..." },
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { field: "eventPlaceDate", label: "Vendi dhe data", placeholder: "p.sh. Tirane, 12.06.2026" },
          { field: "location", label: "Lokacioni" },
          { field: "conferenceDate", label: "Data e eventit", type: "date" },
          ...
          { field: "participationType", label: "Lloji i pjesemarrjes", type: "select", optionsKey: "participation" },
          ...
          { field: "registrationFee", label: "Kosto regjistrimi", placeholder: "p.sh. 220 EUR" },
          { field: "travelCost", label: "Kosto udhetimi", placeholder: "p.sh. 180 EUR" },
          { field: "accommodationCost", label: "Kosto akomodimi", placeholder: "p.sh. 300 EUR" },
        ],
      },
    ],
    attachmentChecklist: [
