...
export const REIMBURSEMENT_SCHEMAS = {
  publication: {
    id: "publication",
    requiredFields: [
      ["publicationId", "Zgjidh artikullin ekzistues."],
    ],
    sections: [
      {
        id: "authors",
      ...
      },
      {
        ...
        fields: [
          { field: "affiliation", label: "Affiliation", wide: true, source: "publication", readOnly: true },
          { field: "publicationTitle", label: "Titulli i artikullit", wide: true, source: "publication", readOnly: true },
          { field: "doi", label: "DOI", source: "publication", readOnly: true },
          { field: "publicationType", label: "Lloji i publikimit", source: "publication", readOnly: true },
          { field: "venue", label: "Publikuar në", source: "publication", readOnly: true },
          { field: "publisher", label: "Shtëpia botuese", source: "publication", readOnly: true },
          { field: "publicationDate", label: "Publikuar më", type: "date", source: "publication", readOnly: true },
          ...
          { field: "volume", label: "Vëllimi", source: "publication", readOnly: true },
...
export const DOCX_LABEL_MAPS = {
  publication: {
    ...
    "PUBLIKUAR NE:": "venue",
    "VENUE / REVISTA / KONFERENCE:": "venue",
    ...
    "ISBN:": "isbn",
    "ABSTRAKTI:": "abstract",
    "INDEKSIM I NË PLATFORMËN:": "indexingPlatform",
    "INDEKSIM I NÃ‹ PLATFORMÃ‹N:": "indexingPlatform",
    "INDEKSIM I NÃƒâ€¹ PLATFORMÃƒâ€¹N:": "indexingPlatform",
    "INDEKSIMI NË PLATFORMËN:": "indexingPlatform",
    "INDEKSIMI NÃ‹ PLATFORMÃ‹N:": "indexingPlatform",
    "IMPAKT FAKTORI (IF):": "impactFactor",
    "KUARTILI:": "scopusQuartile",
    ...
    "EMRI DHE MBIEMRI I APLIKANTIT:": "bankApplicantName",
    ...
    "VENDI:": "bankCountry",
    "EURO SHËNO ME FJALË:": "amountInWords",
    "EURO SHENO ME FJALE:": "amountInWords",
    "EURO SHÃ‹NO ME FJALÃ‹:": "amountInWords",
    "EURO SHÃƒâ€¹NO ME FJALÃƒâ€¹:": "amountInWords",
    "SHËNO ME FJALË:": "amountInWords",
    "SHENO ME FJALE:": "amountInWords",
    "SHÃ‹NO ME FJALÃ‹:": "amountInWords",
    "SHÃƒâ€¹NO ME FJALÃƒâ€¹:": "amountInWords",
