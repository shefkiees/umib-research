...
function mapPublication(row) {
  ...
  const fieldSources = buildPublicationFieldSources({
    ...
    publicationDate: isBookPublication && !isBookChapter ? null : row.publication_date || row.metadata_published_date || null,
    publicationYear: isBookPublication && !isBookChapter ? "" : row.publication_year || row.metadata_year || row.year || "",
    ...
    issn: hideJournalSpecificFields ? "" : nullableConferenceText(publicationType, row.issn || row.metadata_issn),
    eIssn: publicationType === "journal_article" ? normalizeEIssn(row.e_issn || row.metadata_e_issn) : "",
    e_issn: publicationType === "journal_article" ? normalizeEIssn(row.e_issn || row.metadata_e_issn) : "",
    isbn: publicationType === "journal_article" ? "" : nullableConferenceText(publicationType, row.isbn || row.metadata_isbn),
    authorAffiliation,
  ...
  return {
    ...
    publicationDate: isBookPublication && !isBookChapter ? null : row.publication_date || row.metadata_published_date || null,
    publication_date: isBookPublication && !isBookChapter ? null : row.publication_date || row.metadata_published_date || null,
    publicationYear: isBookPublication && !isBookChapter ? "" : row.publication_year || row.metadata_year || row.year || "",
    publication_year: isBookPublication && !isBookChapter ? "" : row.publication_year || row.metadata_year || row.year || "",
    doi: row.doi || "",
    sourceUrl: row.source_url || "",
    ...
    issn: hideJournalSpecificFields ? "" : row.issn || row.metadata_issn || "",
    eIssn: publicationType === "journal_article" ? row.e_issn || row.metadata_e_issn || "" : "",
    e_issn: publicationType === "journal_article" ? row.e_issn || row.metadata_e_issn || "" : "",
    isbn: publicationType === "journal_article" ? "" : row.isbn || row.metadata_isbn || "",
    authorAffiliation,
...
const PUBLICATION_SELECT_SQL = `
  ...
  m.published_date as metadata_published_date, m.year as metadata_year,
  m.issn as metadata_issn, m.e_issn as metadata_e_issn, m.isbn as metadata_isbn,
  coalesce((
