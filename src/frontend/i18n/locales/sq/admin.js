export const adminSq = {
  ...
  audit: {
    ...
    adminEmail: "Email i adminit",
    targetEmail: "Email i subjektit",
    action: "Veprimi",
    status: "Statusi",
    fromDate: "Nga data",
    toDate: "Deri më",
    all: "Të gjitha",
    loading: "Duke ngarkuar historikun...",
    empty: "Nuk ka histori veprimesh për filtrat aktuale.",
    loadError: "Historiku i veprimeve nuk u ngarkua.",
    columns: {
      dateTime: "Data/Ora",
      admin: "Admini",
      action: "Veprimi",
    ...
    actions: {
      all: "Të gjitha veprimet",
      login: "Kyçje e adminit",
      unauthenticated: "Tentim qasjeje pa login",
      forbidden: "Tentim qasjeje pa leje",
      roleUpdate: "Ndryshim roli",
      statusUpdate: "Ndryshim statusi",
      view: "Shiko",
      delete: "Fshi veprimin",
      loadMore: "Shfaq më shumë",
      shownOf: (shown, total) => `${shown} nga ${total}`,
    },
    statuses: {
      success: "Sukses",
      failed: "Dështoi",
    ...
    details: {
      title: "Detajet e veprimit",
      aria: "Detajet e veprimit",
      close: "Mbyll detajet",
      admin: "Admini",
      action: "Veprimi",
      subject: "Subjekti",
