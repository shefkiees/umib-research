export const adminEn = {
  ...
  audit: {
    ...
    empty: "No activity history for the current filters.",
    ...
    actions: {
      all: "All actions",
      login: "Admin login",
      unauthenticated: "Unauthenticated access attempt",
      forbidden: "Forbidden access attempt",
      roleUpdate: "Role change",
