...
function getSelectedIndexingPlatforms(indexing = [], fallback = "") {
...
const PublicationForm = ({
  ...
  const selectedIndexingPlatforms = getSelectedIndexingPlatforms(indexingItems, value.indexingPlatform || value.indexing_platform || primaryIndexing.source || "");
  ...
  const updateIndexingField = (field) => (event) => {
    ...
    const nextPlatforms = field === "indexingPlatform" ? splitIndexingPlatforms(nextValue) : selectedIndexingPlatforms;
