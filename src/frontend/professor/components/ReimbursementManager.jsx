...
function getPublicationIndexingFields(publication) {
  ...
  const indexingPlatform = fallbackPlatform || publication?.indexingPlatform || publication?.indexing_platform || selectedIndexing.source || selectedIndexing.platform || "";
...
function applyPublicationToForm(prev, publication) {
  ...
  return {
    ...
    acceptanceDate: normalizeInputDate(publication.acceptanceDate || publication.acceptance_date),
    acceptance_date: normalizeInputDate(publication.acceptance_date || publication.acceptanceDate),
...
export default function ReimbursementManager({
  ...
  const handleConferencePublicationSelect = (event) => {
    ...
    setForm((prev) => ({
      ...
      eIssn: selectedPublication.eIssn || selectedPublication.e_issn || selectedPublication.eissn || "",
      e_issn: selectedPublication.e_issn || selectedPublication.eIssn || selectedPublication.eissn || "",
